...
public class Categories {
    ...
    public String[] getSubCategoryName() {
        ArrayList<SubCategories> SubCategoriesList = getSubCategories();
        ArrayList<String> SubCategoriesName = new ArrayList<>(); // Initialize SubCategoriesName
        for (SubCategories subCategory : SubCategoriesList) {
            String name = subCategory.getNameOfCategory();
            SubCategoriesName.add(name);
        }
        /*
         * In modern Java, it's common to use new String[0] when you don't know the size
         * of the list in advance, because Java will automatically allocate an array of
         * the right size.
         */
        return SubCategoriesName.toArray(new String[0]); // Convert to array and return
    }
